...
namespace Medikit.Security.Cryptography.Asn1
{
    ...
    {
        internal Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn KeyDerivationFunc;
        internal Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn EncryptionScheme;
        ...
        internal static void Decode(ref AsnValueReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out PBES2Params decoded)
        {
            ...
            Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn.Decode(ref sequenceReader, rebind, out decoded.KeyDerivationFunc);
            Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn.Decode(ref sequenceReader, rebind, out decoded.EncryptionScheme);
