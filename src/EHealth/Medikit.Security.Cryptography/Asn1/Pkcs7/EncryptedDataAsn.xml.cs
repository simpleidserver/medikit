...
namespace Medikit.Security.Cryptography.Asn1.Pkcs7
{
    ...
    internal partial struct EncryptedDataAsn
    {
        ...
        internal Medikit.Security.Cryptography.Asn1.Pkcs7.EncryptedContentInfoAsn EncryptedContentInfo;
        internal Medikit.Security.Cryptography.Asn1.AttributeAsn[] UnprotectedAttributes;
        ...
        internal static void Decode(ref AsnValueReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out EncryptedDataAsn decoded)
        {
            ...
            Medikit.Security.Cryptography.Asn1.Pkcs7.EncryptedContentInfoAsn.Decode(ref sequenceReader, rebind, out decoded.EncryptedContentInfo);
