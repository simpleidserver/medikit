...
namespace Medikit.Security.Cryptography.Asn1
{
    ...
    public partial struct PssParamsAsn
    {
        ...
        public Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn HashAlgorithm;
        public Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn MaskGenAlgorithm;
        ...
        static PssParamsAsn()
        {
            ...
            Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn.Decode(ref reader, rebind, out decoded.HashAlgorithm);
            reader.ThrowIfNotEmpty();

            reader = new AsnValueReader(DefaultMaskGenAlgorithm, AsnEncodingRules.DER);
            Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn.Decode(ref reader, rebind, out decoded.MaskGenAlgorithm);
            reader.ThrowIfNotEmpty();
