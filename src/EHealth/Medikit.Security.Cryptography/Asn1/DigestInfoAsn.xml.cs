...
namespace Medikit.Security.Cryptography.Asn1
{
    ...
    {
        internal Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn DigestAlgorithm;
        ...
        internal static void Decode(ref AsnValueReader reader, Asn1Tag expectedTag, ReadOnlyMemory<byte> rebind, out DigestInfoAsn decoded)
        {
            ...
            Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn.Decode(ref sequenceReader, rebind, out decoded.DigestAlgorithm);
