...
namespace Medikit.Security.Cryptography.Asn1
{
    ...
    internal partial struct PrivateKeyInfoAsn
    {
        ...
        internal Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn PrivateKeyAlgorithm;
        internal ReadOnlyMemory<byte> PrivateKey;
        internal Medikit.Security.Cryptography.Asn1.AttributeAsn[] Attributes;
