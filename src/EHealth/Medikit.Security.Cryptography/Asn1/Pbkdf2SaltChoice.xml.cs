...
namespace Medikit.Security.Cryptography.Asn1
{
    ...
    internal partial struct Pbkdf2SaltChoice
    {
        ...
        internal Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn? OtherSource;
        ...
        internal static void Decode(ref AsnValueReader reader, ReadOnlyMemory<byte> rebind, out Pbkdf2SaltChoice decoded)
        {
            ...
            {
                Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn tmpOtherSource;
                Medikit.Security.Cryptography.Asn1.AlgorithmIdentifierAsn.Decode(ref reader, rebind, out tmpOtherSource);
