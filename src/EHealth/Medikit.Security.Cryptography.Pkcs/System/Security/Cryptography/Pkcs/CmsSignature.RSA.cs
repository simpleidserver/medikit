...
{
    public partial class CmsSignature
    {
                ...
                X509Certificate2 certificate)
            {
                if (_expectedDigest.HasValue && _expectedDigest.Value != digestAlgorithmName)
                {
                    throw new CryptographicException(
                        string.Format(
                            Strings.Cryptography_Cms_InvalidSignerHashForSignatureAlg,
                            digestAlgorithmOid,
                            _signatureAlgorithm));
                }
        ...
        private class RSAPssCmsSignature : RSACmsSignature
        {
                ...
                int digestValueLength)
            {
                if (signatureParameters == null)
                {
                    throw new CryptographicException(Strings.Cryptography_Pkcs_PssParametersMissing);
                }
                ...
                if (pssParams.HashAlgorithm.Algorithm.Value != digestAlgorithmOid)
                {
                    throw new CryptographicException(
                        string.Format(
                            Strings.Cryptography_Pkcs_PssParametersHashMismatch,
                ...
                if (pssParams.SaltLength != digestValueLength)
                {
                    throw new CryptographicException(
                        string.Format(
                            Strings.Cryptography_Pkcs_PssParametersSaltMismatch,
                ...
                {
                    throw new CryptographicException(
                        Strings.Cryptography_Pkcs_PssParametersMgfNotSupported,
                ...
                if (mgfParams.Algorithm.Value != digestAlgorithmOid)
                {
                    throw new CryptographicException(
                        string.Format(
                            Strings.Cryptography_Pkcs_PssParametersMgfHashMismatch,
