...
namespace Medikit.Security.Cryptography.Pkcs
{
    public sealed partial class SignedCms
    {
        ...
        public SignedDataAsn SignedData { get => _signedData; }
        ...
        public byte[] Encode()
        {
            if (!_hasData)
            {
                throw new InvalidOperationException(Strings.Cryptography_Cms_MessageNotSigned);
            }
        ...
        public void ComputeSignature() => ComputeSignature(new CmsSigner(null, SigningPolicy.EHEALTH_CERT, _signerIdentifierType), true);
        ...
        public void ComputeSignature(CmsSigner signer, bool silent)
        {
            ...
            {
                throw new CryptographicException(Strings.Cryptography_Cms_Sign_Empty_Content);
            }
            ...
            if (_hasData && signer.SignerIdentifierType == SubjectIdentifierType.NoSignature)
            {
                ...
                throw new CryptographicException(Strings.Cryptography_Cms_Sign_No_Signature_First_Signer);
            }
            ...
            if (signer.Certificate == null && signer.SignerIdentifierType != SubjectIdentifierType.NoSignature)
            {
                if (silent)
                {
                    ...
                    throw new InvalidOperationException(Strings.Cryptography_Cms_NoSignerCertSilent);
                }
            ...
            if (!_hasData)
            {
                ...
                if (!Detached)
                {
                    ...
                    {
                        writer.WriteBerOctetString(content);
        ...
        public void AddCertificate(X509Certificate2 certificate)
        {
            ...
            if (existingLength > 0)
            {
                foreach (CertificateChoiceAsn cert in _signedData.CertificateSet!)
                {
                    ...
                    {
                        throw new CryptographicException(Strings.Cryptography_Cms_CertificateAlreadyInCollection);
                    }
                }
            }
        ...
        public void RemoveCertificate(X509Certificate2 certificate)
        {
            ...
            throw new CryptographicException(Strings.Cryptography_Cms_NoCertificateFound);
        }
    }
}
