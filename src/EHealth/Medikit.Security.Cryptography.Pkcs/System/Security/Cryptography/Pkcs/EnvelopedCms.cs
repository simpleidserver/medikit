    ...
    public sealed class EnvelopedCms
    {
        ...
        public void Encrypt(CmsRecipientCollection recipients)
        {
            ...
            if (recipients.Count == 0)
                throw new PlatformNotSupportedException(Strings.Cryptography_Cms_NoRecipients);
        ...
        public byte[] Encode()
        {
            if (_encodedMessage == null)
                throw new InvalidOperationException(Strings.Cryptography_Cms_MessageNotEncrypted);
