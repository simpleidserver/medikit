...
using System.Text;
using X509IssuerSerial = Medikit.Security.Cryptography.Xml.X509IssuerSerial;
    ...
    internal static partial class PkcsHelpers
    {
        ...
        internal static HashAlgorithmName GetDigestAlgorithm(string? oidValue, bool forVerification = false)
        {
            switch (oidValue)
            {
                ...
                default:
                    throw new CryptographicException(Strings.Cryptography_UnknownHashAlgorithm, oidValue);
            }
        }
        ...
        internal static string GetOidFromHashAlgorithm(HashAlgorithmName algName)
        {
            ...
            throw new CryptographicException(Strings.Cryptography_Cms_UnknownAlgorithm, algName.Name);
        }
        ...
        public static ReadOnlyMemory<byte> DecodeOctetStringAsMemory(ReadOnlyMemory<byte> encodedOctetString)
        {
            ...
            {
                throw new CryptographicException(Strings.Cryptography_Der_Invalid_Encoding);
            }
            ...
            [NotNullWhen(false)] out Exception? exception)
        {
            ...
            {
                exception = new CryptographicException(Strings.Cryptography_Der_Invalid_Encoding);
                return false;
            }
                ...
                switch (oaepParameters.HashFunc.Algorithm.Value)
                {
                    ...
                    default:
                        exception = new CryptographicException(
                            Strings.Cryptography_Cms_UnknownAlgorithm,
