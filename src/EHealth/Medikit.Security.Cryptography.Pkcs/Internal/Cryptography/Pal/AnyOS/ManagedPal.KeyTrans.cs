...
namespace Internal.Cryptography.Pal.AnyOS
{
    internal sealed partial class ManagedPkcsPal : PkcsPal
    {
            ...
            out bool v0Recipient)
        {
            ...
            else
            {
                throw new CryptographicException(
                    Strings.Cryptography_Cms_Invalid_Subject_Identifier_Type,
            ...
            {
                throw new CryptographicException(Strings.Cryptography_Cms_UnknownAlgorithm);
            }
            ...
            out Exception? exception)
        {
            if (privateKey == null)
            {
                exception = new CryptographicException(Strings.Cryptography_Cms_Signing_RequiresPrivateKey);
                return null;
            }
