    ...
    internal sealed partial class ManagedPkcsPal : PkcsPal
    {
            ...
            byte[] parameterBytes)
        {
            ...
            for (var i = 0; i < recipients.Count; i++)
            {
                ...
                bool v0Recipient = false;
                switch(recipient.Type)
                {
                    case CmsRecipientTypes.KeyTransRecipientInfoAsn:
                        ...
                        break;
                    case CmsRecipientTypes.KEKRecipientInfo:
                        envelopedData.RecipientInfos[i].KrecipientInfo = new KEKRecipientInfoAsn
                        {
                            KEKId = new KEKIdentifierAsn
                            {
