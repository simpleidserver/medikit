...
namespace Internal.Cryptography.Pal.AnyOS
{
    internal sealed partial class ManagedPkcsPal : PkcsPal
    {
        ...
        {
            return new CryptographicException(Strings.Cryptography_Cms_RecipientNotFound);
        }
        ...
        private static Exception CreateInvalidMessageTypeException()
        {
            ...
            return new CryptographicException(Strings.Cryptography_Cms_InvalidMessageType);
        }
    }
}
