...
{
    public class DICSFindAmppRequestBody : SOAPBody
    {
        [XmlElement(ElementName = "FindAmppRequest", Namespace = Constants.Namespaces.DICSV5)]
        public DICSFindAmppRequest Request { get; set; }
