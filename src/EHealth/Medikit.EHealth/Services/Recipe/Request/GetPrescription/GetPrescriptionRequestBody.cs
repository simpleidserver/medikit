...
{
    public class GetPrescriptionRequestBody : SOAPBody
    {
        [XmlElement(ElementName = "GetPrescriptionRequest", Namespace = Constants.Namespaces.RECIPE)]
        public GetPrescriptionRequest Request { get; set; }
