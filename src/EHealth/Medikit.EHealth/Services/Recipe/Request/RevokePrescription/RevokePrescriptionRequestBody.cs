...
{
    public class RevokePrescriptionRequestBody : SOAPBody
    {
        [XmlElement(ElementName = "RevokePrescriptionRequest", Namespace = Constants.Namespaces.RECIPE)]
        public RevokePrescriptionRequest Request { get; set; }
