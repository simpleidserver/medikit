...
namespace Medikit.EHealth.Services.Recipe.Request
{
    public class RevokePrescriptionRequest
    {
        ...
        [XmlElement(ElementName = "SecuredRevokePrescriptionRequest", Namespace = "http://www.w3.org/XML/1998/namespace")]
        public SecuredContentType SecuredRevokePrescriptionRequest { get; set; }

        public XElement Serialize()
        {
            var result = new XElement(Constants.XMLNamespaces.RECIPE + "RevokePrescriptionRequest",
            ...
            if (SecuredRevokePrescriptionRequest != null)
            {
                result.Add(SecuredRevokePrescriptionRequest.Serialize("SecuredRevokePrescriptionRequest"));
            }
