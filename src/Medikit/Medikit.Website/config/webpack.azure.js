...
const API_URL = process.env.API_URL = "https://simpleidserver.northeurope.cloudapp.azure.com/medikitapi";
const OPENID_URL = process.env.OPENID_URL = "https://simpleidserver.northeurope.cloudapp.azure.com/openid";
const REDIRECT_URL = process.env.REDIRECT_URL = "https://simpleidserver.northeurope.cloudapp.azure.com/medikit";
const BASE_URL = process.env.BASE_URL || '/medikit/';
