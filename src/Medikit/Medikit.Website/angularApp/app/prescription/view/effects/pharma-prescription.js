...
var ViewPharmaPrescriptionEffects = (function () {
    function ViewPharmaPrescriptionEffects(actions$, prescriptionService) {
        var _this = this;
    ...
    ], ViewPharmaPrescriptionEffects.prototype, "getPrescription$", void 0);
    ViewPharmaPrescriptionEffects = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [Actions,
            PrescriptionService])
    ], ViewPharmaPrescriptionEffects);
    return ViewPharmaPrescriptionEffects;
}());
export { ViewPharmaPrescriptionEffects };
